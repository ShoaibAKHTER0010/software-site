      ...
      <main className='mx-auto  py-16'>
        ...
        <div className="w-full ">
          ...
          <div className="mx-auto max-w-7xl py-10 ">
            {/* child */}
            <div className="h-1 w-16 bg-gradient-to-bl from-rose-400 to-purple-900 "></div>
...
<span className="text-zinc-300 text-[36.53px] font-bold font-['Poppins'] leading-[43.26px]">Who are Working With us</span></h2>
          ...
          <Marquee>
            ...
            <div className="rounded-xl shadow-2xl mx-12 hover:border-2 hover:border-rose-400 ">
               <img src="./images/pic-a.jpg" alt="person-1" className="h-[200px] rounded-full" />
             ...
             <img src="./images/pic-b.jpg" alt="person-2" className="h-[200px] rounded-full" />
             ...
             {/* user three */}
             <div className="rounded-xl shadow-lg mx-12 hover:border-2 hover:border-rose-400">
             <img src="./images/pic-c.jpg" alt="person-3" className="h-[200px] rounded-full" />
               <h2 className="font-bold text-xl text-center pt-4">Shoaib Akhter</h2>
               <p className="text-center py-2">front-end developer</p>
                  </div>
                {/* user four */}
                <div className="rounded-xl shadow-lg mx-12 hover:border-2 hover:border-rose-400">
             <img src="./images/pic-d.jpg" alt="person-4" className="h-[200px] rounded-full" />
              ...
              {/* user five */}
              <div className="rounded-xl shadow-lg mx-12 hover:border-2 hover:border-rose-400">
             <img src="./images/pic-e.jpg" alt="person-4" className="h-[200px] rounded-full" />
