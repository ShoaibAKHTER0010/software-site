            ...
            <div className='w-full '>
                ...
                <div className='flex flex-col md:flex-row gap-8'>
                    ...
                    <div className='flex flex-col justify-center items-center'>
                        ...
                        {/* empity */}
                        <div className=" mt-4 w-[31.24px] h-[0px] origin-top-left rotate-90 border-2 border-rose-400 rounded-full"></div>
                    </div>
                    ...
                    <div className='flex flex-col justify-center items-center'>
                        ...
                        {/* empity */}
                        <div className="w-[31.24px] h-[0px] origin-top-left rotate-90 border-2 border-rose-400  mt-4 rounded-full "></div>
                    </div>
