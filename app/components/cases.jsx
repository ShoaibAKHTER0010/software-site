...
const Cases = () => {
 ...
 Case studies </h2>
                ...
                {/* case-1 */}
                <div className='w-full flex flex-col md:flex-row   border-2 border-emerald-50 rounded-xl bg-[#1d1c1c]'>
                 {/* part-1 */}
                 ...
                 <img src="./images/case-1.png" alt="img" />
                  ...
                  <div className='w-full md:w-1/2 p-12 '>
                    ...
                    {/* button */}
                    <div className="w-full flex flex-col md:flex-row justify-end mt-24">
